...
import { ErrorIcon, LoadingSpinner, LoginIcon, UserIcon } from "./Icon";
...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-bg overflow-hidden relative">
      <motion.div
        className="absolute -top-20 -left-20 w-72 h-72 rounded-full bg-light-primary opacity-50 blur-2xl"
      ...
      <motion.div
        className="absolute top-10 right-10 w-52 h-52 rounded-full bg-dark-primary opacity-50 blur-2xl"
